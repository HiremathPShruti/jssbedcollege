                    ...
                    <div class="cont-subs">
                        <div class="cont-add">
                           ...
                           <div class="cont-add-rgt">
                            <h4>Address:</h4>
                            <p class="contact-text-sub">JSS Sri Manjunatheshwara College of Education
...
Vidyagiri , Dharwad</p>
                        ...
                        <div class="cont-add add-2">
                           ...
                           <div class="cont-add-rgt">
                            <h4>Email:</h4>
                            <a href="mailto:jssbedcollege@rediffmail.com">
                                <p class="contact-text-sub">jssbedcollege@rediffmail.com</p>
                            </a>
                        </div>
                        <div class="cont-add-lft">
                        ...
                        <div class="cont-add">
                            ...
                            <div class="cont-add-rgt">
                                 <h4>Phone:</h4>
                                 <a href="tel:0836-2466827">
                                    <p class="contact-text-sub">0836-2466827</p>
                                 </a>
                            </div>
                            <div class="cont-add-lft">
        ...
        <!-- map -->
        <div class="map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d961.4550257471616!2d75.01987512920647!3d15.440257892032012!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bb8d264f4bd8b57%3A0x71701e0179184c8e!2sShri%20Manjunatheshwar%20College%20Of%20Education!5e0!3m2!1sen!2sin!4v1601651122515!5m2!1sen!2sin" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
        <!-- //map -->
    </div>
</section>
