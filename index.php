            ...
            <div class="banner-info">
              <div class="container">
                <div class="banner-info-bg mx-auto text-center">
                 ...
                 <a class="btn btn-secondary btn-theme2 mt-md-5 mt-4" href="index.php">Read More</a>
                </div>
		...
		<div class="container">
			...
			<div class="middle-section grid-column text-center">
				<div class="three-grids-columns">
					...
					<a href="index.php" class="btn btn-secondary btn-theme3 mt-4">Read More </a>
				</div>
				<div class="three-grids-columns">
		...
		<div class="container py-md-3">
			...
			<div class="calltoaction-20-content row">
				<div class="column center-align-self col-lg-6 pr-lg-5">
					...
					<p class="more-gap editContent" align="justify">J.S.S. Sri Manjunatheshwara College of Education, Vidyagiri, Dharwad was started in 2007
					in the J.S.S. Campus. The beautiful college situated in a well spacious area in the J.S.S Campus. The College aims at
					preparing teachers who help to shape the tender minds into humane, creative & innovative citizens of the society. 
					The institution has focused to meet the demands of modern society providing skillful training to student teachers. 
					The college has a Governing Council
					and Academic Advisory Council of the College which monitors and guides the academic & administrative aspects of the
					college.</p>
						
							<a class="btn btn-secondary btn-theme2 mt-3" href="about.html"> Read More</a>
				</div>
				<div class="column ccont-left col-lg-6">
					<img src="assets/images/jss.jpg" class="img-responsive" alt="">
				</div>
			</div>
		</div>
	</div>
			...
			<div class="grid grid-column-2 ">
				...
				<div class="column1">
					<div class="heading">
						...
						<h4>Fall 2020 applications are now open</h4>
					...
					<div class="column1">
						...
						<div class="row">
							<div class="col-md-3 col-sm-6 col-6">
								<a href="index.php"><div class="courses-item">
							...
							<div class="col-md-3 col-sm-6 col-6 mt-4">
								<a href="index.php"><div class="courses-item mt-2">
              ...
              <div class="pricing-chart col-lg-6">
				...
				<marquee direction="up" scrollamount="5" onMouseOver="this.stop();" onMouseOut="this.start();">
                        <div class="price-box btn-layout bt6">
                            <div class="grid grid-column-2">
                                ...
                                <div class="column1">
                                    ...
                                    <div class="job-info">
                                        <h6 class="pricehead"><a href="#">College opening </a></h6>
                                        <h5>October 25, 2020</h5>
                                        <p>College to be reopened</p>
                                    </div>
                                </div>
                                ...
                                <div class="column1">
                                   <div class="job-info">
                                        <h6 class="pricehead"><a href="#">	
                                            About Safety</a></h6>
                                       <h5>October 05, 2020</h5>
                                       <p>Students requested to always carry mask and sanitisers</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-column-2">
                                ...
                                <div class="column1">
                                    ...
                                    <div class="job-info">
                                        ...
                                        <h5>October 25, 2020</h5>
                                        <p>New timetable has been released</p>
                                    </div>
                                </div>
                    ...
                    <div class="text-right mt-4">
                        <a class="btn btn-secondary btn-theme2" href="news.php"> View All</a>
                      </div>
                    </div>
                    <div class="w3l-faq-page col-lg-6 pl-3 pl-lg-5 mt-lg-0 mt-5">
                        ...
                        <div class="events-top mt-md-5 mt-4">
                            ...
                            <div class="events-top-right">
                                <h6 class="pricehead"><a href="#">	
                                    ...
                                    <p class="mb-2 mt-3">College will be reopemning</p>
                                    <li>07:00 - 10:00 </li>
                                    <li class="melb">JSS Dharwad</li>
                            </div>
                        </div>
                        <div class="events-top mt-4">
                            ...
                            <div class="events-top-right">
                                <h6 class="pricehead"><a href="#">	
                                   Lecture On student safety measures </a></h6>
                                    <p class="mb-2 mt-3">Its important to take proper safety measures </p>
                                    <li>07:00 - 10:00 </li>
                                    <li class="melb">JSS Dharwad</li>
                            </div>
                        </div>
